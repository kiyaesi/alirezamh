...
/* 
	...
	setHLAdjustMethod (methodID)	// adjust method for higher latitudes
...
PrayTime.prototype.setHLAdjustMethod = function(methodID)
{
...
{
	if (timeZone == null || typeof(timeZone) == 'undefined' || timeZone == 'auto' || timeZone == '')
